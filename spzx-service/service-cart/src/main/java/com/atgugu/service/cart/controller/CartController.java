...
public class CartController {
    ...
    public Result<List<CartInfo>> cartList(@Parameter(description = "登录token", required = true) @RequestHeader("token") String token) {
    ...
    public Result clearCart(@Parameter(description = "登录token", required = true) @RequestHeader("token") String token){
    ...
    public List<CartInfo> getAllCkecked(@Parameter(description = "登录token", required = true) @RequestHeader("token") String token) {
